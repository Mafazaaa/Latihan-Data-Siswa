...
<body>
    <header class="bg-gray-200 shadow flex justify-between items-center px-4 py-6">
        ...
        <div class="flex items-center space-x-2">
            <form action="{{ route('students.index') }}" method="GET" class="flex">
                <div class="relative">
                    <label for="search"
                        class="hidden mb-2 text-sm font-medium text-gray-200 dark:text-gray-300">Search</label>
    ...
    <div class="py-4 px-0 mx-auto max-w-screen-xl lg:py-8 lg:px-0">
        <div class="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            @forelse ($students as $student)
                @if (is_object($student))
                    <div class="flex flex-col">
                        <article class="flex flex-col h-full p-4 bg-gray-200 rounded-lg border border-gray-200 shadow-md mb-8">
                            ...
                            <div class="flex justify-between mt-14 space-x-2">
            ...
            @empty
                <div class="flex justify-center items-center my-8">
                    <h1 class="text-3xl font-bold">Data Siswa Sekolah Tidak Ditemukan</h1>
                </div>
            @endforelse
        </div>
    </div>
